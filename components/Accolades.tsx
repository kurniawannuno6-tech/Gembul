...
// Award badges shown at the bottom of the text panel — edit as needed
const awards = [
  { year: "2024", name: "Michelin\nStar" },
  { year: "2023", name: "Best Fine\nDining" },
  { year: "2022", name: "Chef of\nthe Year" },
];
...
export default function Accolades() {
  ...
  return (
    <section id="accolades" className="grid md:grid-cols-2 min-h-[70vh]">
      ...
      <div
        ref={textRef}
        className="flex flex-col justify-center px-10 md:px-20 py-24 order-2 md:order-1"
      ...
      >
        ...
        <p data-reveal className="text-[0.8rem] leading-[2.1] mb-5" style={{ color: "var(--color-cream)", opacity: 0.65 }}>
          Our Head Chef is an innovative and highly awarded master within the culinary realm.
          Her expertise and effortless authenticity has been entwined with the bon vivant spirit of Roti Gembul.
        </p>
        <p data-reveal className="text-[0.8rem] leading-[2.1] mb-12" style={{ color: "var(--color-cream)", opacity: 0.65 }}>
          Prestigious commendations and international recognition year after year affirm our
        ...
        <div ref={badgesRef} className="flex gap-5 flex-wrap">
          {awards.map((a) => (
            <div
              key={a.year}
              data-badge
              className="text-center border px-6 py-5 min-w-[100px] transition-all duration-300 hover:border-[#b8965a]"
              style={{ borderColor: "rgba(184,150,90,0.3)", color: "var(--color-cream)" }}
            >
              <span className="block text-[0.58rem] tracking-[0.25em] uppercase mb-1" style={{ color: "var(--color-gold)" }}>
                {a.year}
              </span>
